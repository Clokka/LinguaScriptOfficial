...
const YouTube = () => (
  <svg viewBox="0 0 48 34" className="h-9 w-auto" aria-label="YouTube" role="img">
...
const Netflix = () => (
  <svg viewBox="0 0 34 34" className="h-9 w-auto" aria-label="Netflix" role="img">
...
const Crunchyroll = () => (
  <svg viewBox="0 0 34 34" className="h-9 w-auto" aria-label="Crunchyroll" role="img">
