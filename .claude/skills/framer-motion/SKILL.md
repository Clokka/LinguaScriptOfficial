...
name: framer-motion
description: |
  Framer Motion animation patterns for React: motion elements, variants and
  orchestration, AnimatePresence for mount/unmount transitions, layout/layoutId
  FLIP animations, scroll-linked effects (useScroll/useTransform), spring config,
  drag and hover/tap gestures, imperative useAnimation control, and reduced-motion
  handling. Use when adding or reviewing animations, page transitions, scroll
  reveals, stagger effects, shared-element transitions, or drag interactions in
